...
$extras = Horas_Extras::Extras();
 ...
 <form  action="../../controller/horas_extras.php" method="post">
      ...
      <br>
            ...
            <br>
            <br><button class="btn btn-warning" type="button" name="button"><a  href="../sections/formatohoras.php?Consulta=<?php echo $ver[0];?>" target="blank">descargar</a> </button>
            <br>
            <br>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    en /*funcion en no funcionamiento*/
